...
import star from "assets/website/img/star.svg";
import star_blank from "assets/website/img/star_blank.svg";
import img1 from "assets/website/img/img1.jpg";
import img2 from "assets/website/img/img2.jpg";
  ...
  return (
    <section className="booking-info">
      <div className="container">
        ...
        <div className="container mg-btm-60">
          <h3>Just Booked</h3>
          <div className="row">
            <div className="col-md-4 book-hotel-card">
