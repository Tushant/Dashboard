...
import stay from "assets/website/img/destination/stay.svg";
import fly from "assets/website/img/destination/fly.svg";
import ride from "assets/website/img/destination/ride.svg";
  ...
  render() {
    ...
    return (
      <div className="container-fluid masthead">
        <h2 className="destination-header">Find Your Destination</h2>
        <Masonry
          elementType={"div"}
